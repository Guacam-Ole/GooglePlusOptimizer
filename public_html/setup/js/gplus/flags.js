var gpoFlags = function () {
    this.Languages = [
        {short: "de", img: "Germany"}, {short: "en-uk", img: "United_Kingdom"}, {
            short: "es",
            img: "Spain"
        }, {short: "pt", img: "Portugal"},
        {short: "fr", img: "France"}, {short: "ru", img: "Russia"}, {short: "hr", img: "Croatia"}, {
            short: "no",
            img: "Norway"
        },
        {short: "da", img: "Denmark"}, {short: "fi", img: "Finland"}, {short: "sv", img: "Sweden"}, {
            short: "tr",
            img: "Turkey"
        },
    ...
    Dom: function ($ce) {
        if ($('.langSelect').length === 0) {
            ...
            if (oldLang !== undefined && oldLang !== null) {
                ...
                var selectedLang = $.grep(obj.Languages, function (e) {
